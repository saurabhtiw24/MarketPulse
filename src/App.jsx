...
const GLOBAL_STYLES = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  button:focus-visible { outline: 2px solid #4fffb0; outline-offset: 2px; }
  a:focus-visible { outline: 2px solid #4fffb0; outline-offset: 2px; }
`;
    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 12, justifyContent: "space-between" }}>
          <div>
            <div style={{
              fontFamily: "'DM Mono',monospace", fontSize: 8, color: "#4fffb0",
              letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 2,
            }}>
              NSE · {NSE_STOCKS.length} STOCKS · LIVE + AI
            </div>
            <h1 style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 19, color: "#fff", lineHeight: 1 }}>
            ...
            {["trader", "investor"].map((m) => (
              <button
                ...
                style={{
                  ...
                  background: mode === m
                    ? (m === "trader" ? "rgba(79,255,176,0.18)" : "rgba(116,185,255,0.18)")
                    : "transparent",
                  color: mode === m
                    ? (m === "trader" ? "#4fffb0" : "#74b9ff")
                    : "#7a8299",
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 12, flexWrap: "wrap" }}>
          <div style={{ position: "relative", flex: 1, minWidth: 200 }}>
            <span style={{
              ...
              fontSize: 12, color: "#5a6278", pointerEvents: "none",
            }}>🔍</span>
            <input
              value={search}
              onChange={handleSearchChange}
              placeholder={`Search ${NSE_STOCKS.length} NSE stocks by name, symbol or sector…`}
          ...
          <div style={{
            ...
            borderRadius: 8, fontSize: 10, color: "#7a8299",
      ...
      {/* ── BODY ────────────────────────────────────────────────────────── */}
      <main style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 0, maxWidth: 1200, margin: "0 auto" }}>
        ...
        <section aria-label="Stock list" style={{ borderRight: "1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div style={{
            ...
            {["Company", "1M", "Price / Chg", ""].map((h) => (
              <div key={h} style={{
                fontSize: 9, color: "#5a6278", fontFamily: "'DM Mono',monospace",
